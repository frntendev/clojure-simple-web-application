(defproject ticket4sale "0.1.0-SNAPSHOT"

  :description "Clojure Simple Web Application"
  ...
  :main ^:skip-aot ticket4sale.core
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "ticket4sale.core/mount-components"}
                     :compiler
                     {:main "ticket4sale.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
